...
import math
import random
import plotly.plotly as plot12
from plotly import *
...
PLOTLY_USERNAME = "shivam1104"
PLOTLY_KEY = "i6bg8eejkw"
...
def plotClusters(data):
    ...
    # Log in to plotly
    print PLOTLY_USERNAME+PLOTLY_KEY
    py = plot12.sign_in(PLOTLY_USERNAME,PLOTLY_KEY)
    print py
    ...
    #if(py!=null):
    resp = plot12.offline.plot(traceList)
    print resp
